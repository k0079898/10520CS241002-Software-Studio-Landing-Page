function init() {
    var e = {
            zoom: 18,
            center: new google.maps.LatLng(24.794980, 120.992157),
            disableDefaultUI: !0,
            scrollwheel: !1,
            draggable: !1,
            styles: [{
    ...
    var l = "img/map-marker.svg",
        o = new google.maps.LatLng(24.794980, 120.992157);
    ...
    "use strict";
    e("a.page-scroll").bind("click", function(t) {
        var l = e(this);
        e("html, body").stop().animate({
            scrollTop: e(l.attr("href")).offset().top - 50
        ...
        e("body").on("input propertychange", ".floating-label-form-group", function(t) {
